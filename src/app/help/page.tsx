...
const faqItems = [
  ...
  { qEn: 'How do I contact support?', qSw: 'Ninawasiliananaje na msaada?', aEn: 'You can reach us via WhatsApp, email at support@hakiki.co.tz, or phone. Our team responds within 2 hours during business hours.', aSw: 'Unaweza kutufikia kupitia WhatsApp, barua pepe support@hakiki.co.tz, au simu. Timu yetu inajibu ndani ya masaa 2 wakati wa kazi.' },
]
    ...
    <main>
      ...
      <section className={styles.hero}>
        <div className="container">
          ...
          <p>{isEn ? 'Find answers to common questions about Hakiki vehicle history reports.' : 'Pata majibu ya maswali ya kawaida kuhusu ripoti za historia ya gari za Hakiki.'}</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className={styles.contactGrid}>
            ...
            <div className={styles.contactCard}>
              ...
              <a href="mailto:support@hakiki.co.tz">support@hakiki.co.tz</a>
            </div>
            <div className={styles.contactCard}>
              <Phone size={24} />
